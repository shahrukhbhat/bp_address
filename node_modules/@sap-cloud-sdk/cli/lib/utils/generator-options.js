...
exports.generatorOptionsSDK = void 0;
const path_1 = require("path");
exports.generatorOptionsSDK = {
    inputDir: {
        alias: 'i',
    ...
    useSwagger: {
        describe: 'Augment parsed information with information from swagger definition files. Files are expected to have the same name as the edmx file, but with .json as suffix.',
        type: 'boolean',
        default: false,
        hidden: true
    },
    ...
    aggregatorNpmPackageName: {
        describe: 'When provided, the generator will generate an additional package with the provided name that has dependencies to all other generated packages.',
        type: 'string',
        hidden: true
    },
    ...
    generateTypedocJson: {
        describe: 'By default, the generator will generate a typedoc.json file for each package, used for the corresponding "doc" npm script. When set to false, the generator will skip the generation of the typedoc.json.',
        type: 'boolean',
        default: true
    },
    generatePackageJson: {
