...
var ODataBatchRequestBuilderV2 = /** @class */ (function (_super) {
     ...
     */
    function ODataBatchRequestBuilderV2(defaultServicePath, requests, entityToConstructorMap) {
    ...
    ODataBatchRequestBuilderV2.prototype.detectLineBreak = function (response) {
...
function toRequestBody(request) {
    if (request instanceof request_builder_1.GetAllRequestBuilderV2 ||
        request instanceof request_builder_1.GetByKeyRequestBuilderV2) {
        return odata_batch_retrieve_request_1.toBatchRetrieveBodyV2(request);
    }
    if (request instanceof odata_batch_change_set_1.ODataBatchChangeSetV2) {
        return odata_batch_change_set_1.toBatchChangeSetV2(request);
    }
...
var asReadResponse = function (body) { return function (constructor) {
    ...
    if (response_data_accessor_1.isCollectionResult(body)) {
        return response_data_accessor_1.getCollectionResult(body).map(function (r) {
            return entity_deserializer_1.deserializeEntityV2(r, constructor);
        });
    }
    return [entity_deserializer_1.deserializeEntityV2(response_data_accessor_1.getSingleResult(body), constructor)];
}; };
var asWriteResponse = function (body) { return function (constructor) {
    ...
    return entity_deserializer_1.deserializeEntityV2(resultData, constructor);
}; };
/*
E.g. response:
--batch_1234
