 ...
 */
export declare class DeleteRequestBuilderV2<EntityT extends EntityV2> extends MethodRequestBuilderBase<ODataDeleteRequestConfig<EntityT>> implements EntityIdentifiable<EntityT> {
     ...
     */
    constructor(entityConstructor: Constructable<EntityT>, keysOrEntity: MapType<FieldType> | EntityV2);
    /**
