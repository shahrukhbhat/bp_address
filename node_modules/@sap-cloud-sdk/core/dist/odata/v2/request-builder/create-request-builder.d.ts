 ...
 */
export declare class CreateRequestBuilderV2<EntityT extends EntityV2> extends MethodRequestBuilderBase<ODataCreateRequestConfig<EntityT>> implements EntityIdentifiable<EntityT> {
     ...
     */
    asChildOf<ParentEntityT extends EntityV2>(parentEntity: ParentEntityT, linkField: Link<ParentEntityT, EntityT>): this;
    /**
     * Execute query.
     *
