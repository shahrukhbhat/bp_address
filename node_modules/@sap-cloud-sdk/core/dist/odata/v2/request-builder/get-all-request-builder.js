...
var GetAllRequestBuilderV2 = /** @class */ (function (_super) {
     ...
     */
    function GetAllRequestBuilderV2(_entityConstructor) {
        var _this = _super.call(this, new odata_get_all_request_config_1.ODataGetAllRequestConfig(_entityConstructor, uri_conversion_1.oDataUriV2)) || this;
     ...
     */
    GetAllRequestBuilderV2.prototype.select = function () {
        var selects = [];
     ...
     * @returns The request builder itself, to facilitate method chaining
     */
    GetAllRequestBuilderV2.prototype.filter = function () {
        var expressions = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            expressions[_i] = arguments[_i];
        }
        this.requestConfig.filter = common_1.and.apply(void 0, expressions);
        return this;
    };
    /**
     ...
     * @returns The request builder itself, to facilitate method chaining
     */
    GetAllRequestBuilderV2.prototype.orderBy = function () {
        var orderBy = [];
        for (var _i = 0; _i < arguments.length; _i++) {
     ...
     * @returns The request builder itself, to facilitate method chaining
     */
    GetAllRequestBuilderV2.prototype.top = function (top) {
     ...
     * @returns The request builder itself, to facilitate method chaining
     */
    GetAllRequestBuilderV2.prototype.skip = function (skip) {
