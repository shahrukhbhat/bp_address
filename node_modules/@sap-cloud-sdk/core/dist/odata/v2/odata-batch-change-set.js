...
exports.toBatchChangeSet = exports.ODataBatchChangeSet = exports.toBatchChangeSetV2 = exports.ODataBatchChangeSetV2 = void 0;
 ...
 */
var ODataBatchChangeSetV2 = /** @class */ (function () {
    function ODataBatchChangeSetV2(requests, changeSetId) {
        if (changeSetId === void 0) { changeSetId = uuid_1.v4(); }
        this.requests = requests;
        this.changeSetId = changeSetId;
    }
    return ODataBatchChangeSetV2;
}());
exports.ODataBatchChangeSetV2 = ODataBatchChangeSetV2;
exports.ODataBatchChangeSet = ODataBatchChangeSetV2;
/**
...
function toRequestPayload(request, changeSetId) {
    if (request instanceof request_builder_1.CreateRequestBuilderV2 ||
        request instanceof request_builder_1.UpdateRequestBuilderV2) {
        request.prepare();
    }
...
function toEtagHeaderValue(request) {
    if (request instanceof request_builder_1.UpdateRequestBuilderV2 ||
        request instanceof request_builder_1.DeleteRequestBuilderV2) {
