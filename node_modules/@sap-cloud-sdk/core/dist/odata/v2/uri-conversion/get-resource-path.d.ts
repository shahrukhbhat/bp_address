 ...
 */
export declare function getResourcePathForKeys<EntityT extends EntityBase>(keys: MapType<FieldType> | undefined, entityConstructor: Constructable<EntityT>): string;
