...
export interface ODataUri {
    ...
    getEntityKeys<EntityT extends EntityBase>(entity: EntityT, entityConstructor: Constructable<EntityT>): MapType<any>;
    getOrderBy<EntityT extends EntityBase>(orderBy: Orderable<EntityT>[]): Partial<{
        orderby: string;
    }>;
    getResourcePathForKeys<EntityT extends EntityBase>(keys: MapType<FieldType>, entityConstructor: Constructable<EntityT>): string;
