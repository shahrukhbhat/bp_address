...
var ComplexTypeField = /** @class */ (function (_super) {
     ...
     */
    function ComplexTypeField(fieldName, fieldOf, complexTypeOrName) {
        var _this = _super.call(this, fieldName, getEntityConstructor(fieldOf)) || this;
        _this.fieldOf = fieldOf;
        if (typeof complexTypeOrName === 'string') {
            _this.complexTypeName = complexTypeOrName;
        }
        else if (complex_type_namespace_1.isComplexTypeNameSpace(complexTypeOrName)) {
...
function getEdmType(complexTypeNameOrEdmType, edmTypeOrUndefined) {
    if (edmTypeOrUndefined) {
        if (typeof complexTypeNameOrEdmType === 'string' &&
            !edm_types_1.isEdmType(complexTypeNameOrEdmType) &&
            edm_types_1.isEdmType(edmTypeOrUndefined)) {
            return edmTypeOrUndefined;
        }
    }
    else if (edm_types_1.isEdmType(complexTypeNameOrEdmType)) {
