...
import { EntityBase, Constructable, ComplexTypeNamespace, EdmTypeShared } from '../common';
...
export interface EntityDeserializer<EntityT extends EntityBase = any> {
    ...
    deserializeComplexType: (json: MapType<any>, complexType: ComplexTypeNamespace<any>) => any;
}
...
declare type ExtractODataETagType = (json: MapType<any>) => string | undefined;
declare type ExtractDataFromOneToManyLinkType = (data: any) => any[] | undefined;
/**
 ...
 */
export declare function entityDeserializer<EntityT, JsonT>(edmToTs: EdmToTsTypeV2 | EdmToTsTypeV4, extractODataETag: ExtractODataETagType, extractDataFromOneToManyLink: ExtractDataFromOneToManyLinkType): EntityDeserializer;
 ...
 */
export declare function extractCustomFields<EntityT extends EntityBase, JsonT>(json: Partial<JsonT>, entityConstructor: Constructable<EntityT>): MapType<any>;
export {};
