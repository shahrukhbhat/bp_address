...
function endsWith(str, suffix) {
    return filter_function_1.filterFunction('endswith', 'boolean', str, suffix);
}
...
function startsWith(str, prefix) {
    return filter_function_1.filterFunction('startswith', 'boolean', str, prefix);
}
 ...
 */
function length(str) {
    return filter_function_1.filterFunction('length', 'int', str);
}
...
function indexOf(str, substr) {
    return filter_function_1.filterFunction('indexof', 'int', str, substr);
}
...
function substring(str, pos, len) {
    return typeof len === 'undefined'
        ? filter_function_1.filterFunction('substring', 'string', str, pos)
        : filter_function_1.filterFunction('substring', 'string', str, pos, len);
}
...
function toLower(str) {
    return filter_function_1.filterFunction('tolower', 'string', str);
}
...
function toUpper(str) {
    return filter_function_1.filterFunction('toupper', 'string', str);
}
 ...
 */
function trim(str) {
    return filter_function_1.filterFunction('trim', 'string', str);
}
exports.trim = trim;
/**
...
function concat(str1, str2) {
    return filter_function_1.filterFunction('concat', 'string', str1, str2);
}
 ...
 * @returns The newly created filter function
 */
function round(num, returnType) {
    if (returnType === void 0) { returnType = 'double'; }
    return filter_function_1.filterFunction('round', returnType, num);
}
exports.round = round;
/**
 ...
 * @returns The newly created filter function
 */
function floor(num, returnType) {
    if (returnType === void 0) { returnType = 'double'; }
    return filter_function_1.filterFunction('floor', returnType, num);
}
exports.floor = floor;
/**
 ...
 * @returns The newly created filter function
 */
function ceiling(num, returnType) {
    if (returnType === void 0) { returnType = 'double'; }
    return filter_function_1.filterFunction('ceiling', returnType, num);
}
 ...
 */
function day(date) {
    return filter_function_1.filterFunction('day', 'int', date);
}
exports.day = day;
/**
 ...
 */
function hour(date) {
    return filter_function_1.filterFunction('hour', 'int', date);
}
exports.hour = hour;
/**
...
function minute(date) {
    return filter_function_1.filterFunction('minute', 'int', date);
}
 ...
 */
function month(date) {
    return filter_function_1.filterFunction('month', 'int', date);
}
exports.month = month;
/**
...
function second(date) {
    return filter_function_1.filterFunction('second', 'int', date);
}
 ...
 */
function year(date) {
    return filter_function_1.filterFunction('year', 'int', date);
}
exports.year = year;
function isOf(expressionOrType, type) {
    return type
        ? filter_function_1.filterFunction('isof', 'boolean', expressionOrType, type)
        : filter_function_1.filterFunction('isof', 'boolean', expressionOrType);
}
exports.isOf = isOf;
/**
