...
export interface EntitySerializer<EntityT extends EntityBase = any, ComplexTypeNamespaceT extends ComplexTypeNamespace<any> = any> {
    serializeEntity: (entity: EntityT, entityConstructor: Constructable<EntityT>) => MapType<any>;
    serializeComplexType: (fieldValue: any, complexTypeNameSpace: ComplexTypeNamespaceT) => any;
    serializeEntityNonCustomFields: (entity: EntityT, entityConstructor: Constructable<EntityT>) => MapType<any>;
}
