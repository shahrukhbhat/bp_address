...
exports.toBatchChangeSetV4 = exports.ODataBatchChangeSetV4 = void 0;
 ...
 */
var ODataBatchChangeSetV4 = /** @class */ (function () {
    function ODataBatchChangeSetV4(requests, changeSetId) {
        if (changeSetId === void 0) { changeSetId = uuid_1.v4(); }
        this.requests = requests;
        this.changeSetId = changeSetId;
    }
    return ODataBatchChangeSetV4;
}());
exports.ODataBatchChangeSetV4 = ODataBatchChangeSetV4;
/**
...
function toRequestPayload(request, changeSetId) {
    if (request instanceof request_builder_1.CreateRequestBuilderV4 ||
        request instanceof request_builder_1.UpdateRequestBuilderV4) {
        request.prepare();
    }
...
function toEtagHeaderValue(request) {
    if (request instanceof request_builder_1.UpdateRequestBuilderV4 ||
        request instanceof request_builder_1.DeleteRequestBuilderV4) {
