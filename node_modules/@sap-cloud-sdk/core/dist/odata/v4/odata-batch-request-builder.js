...
var ODataBatchRequestBuilderV4 = /** @class */ (function (_super) {
     ...
     */
    function ODataBatchRequestBuilderV4(defaultServicePath, requests, entityToConstructorMap) {
    ...
    ODataBatchRequestBuilderV4.prototype.detectLineBreak = function (response) {
...
function toRequestBody(request) {
    if (request instanceof request_builder_1.GetAllRequestBuilderV4 ||
        request instanceof request_builder_1.GetByKeyRequestBuilderV4) {
        return odata_batch_retrieve_request_1.toBatchRetrieveBodyV4(request);
    }
    if (request instanceof odata_batch_change_set_1.ODataBatchChangeSetV4) {
        return odata_batch_change_set_1.toBatchChangeSetV4(request);
    }
...
var asReadResponse = function (body) { return function (constructor) {
    ...
    if (response_data_accessor_1.isCollectionResult(body)) {
        return response_data_accessor_1.getCollectionResult(body).map(function (r) {
            return entity_deserializer_1.deserializeEntityV4(r, constructor);
        });
    }
    return [entity_deserializer_1.deserializeEntityV4(response_data_accessor_1.getSingleResult(body), constructor)];
}; };
var asWriteResponse = function (body) { return function (constructor) {
    ...
    return entity_deserializer_1.deserializeEntityV4(resultData, constructor);
}; };
/*
E.g. response:
--batch_1234
