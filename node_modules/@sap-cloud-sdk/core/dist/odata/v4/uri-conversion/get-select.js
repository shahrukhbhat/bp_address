 ...
 */
function getSelectV4(selects) {
    if (selects === void 0) { selects = []; }
    var selection = selects.map(function (select) { return select._fieldName; });
    if (selection.length) {
        if (selection.find(function (select) { return select.endsWith('*'); })) {
            return { select: '*' };
        }
...
exports.getSelectV4 = getSelectV4;
