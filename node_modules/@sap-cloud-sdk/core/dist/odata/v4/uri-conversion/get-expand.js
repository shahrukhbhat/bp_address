...
function getExpandAsString(expand, entityConstructor) {
    var _a;
    if (expand instanceof common_1.AllFields) {
        return '*';
    }
    var params = {};
    if (expand instanceof common_1.Link) {
        ...
        if (expand instanceof one_to_many_link_1.OneToManyLink) {
            params = __assign(__assign(__assign(__assign({}, params), common_1.createGetFilter(uri_value_converter_1.uriConverterV4).getFilter(common_1.and.apply(void 0, (_a = expand._filters) === null || _a === void 0 ? void 0 : _a.filters), entityConstructor)), (expand._skip && { skip: expand._skip })), (expand._top && { top: expand._top }));
        }
