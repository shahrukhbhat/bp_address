...
import { EntityIdentifiable, Constructable, Selectable, Filterable, Orderable } from '../../common';
 ...
 */
export declare class GetAllRequestBuilderV4<EntityT extends EntityV4> extends MethodRequestBuilderBase<ODataGetAllRequestConfig<EntityT>> implements EntityIdentifiable<EntityT> {
