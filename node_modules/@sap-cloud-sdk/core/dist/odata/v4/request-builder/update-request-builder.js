...
var UpdateRequestBuilderV4 = /** @class */ (function (_super) {
    ...
    UpdateRequestBuilderV4.prototype.prepare = function () {
        ...
        switch (this.requestConfig.method) {
            case 'put':
                updateBody = entity_serializer_1.serializeEntityV4(this._entity, this._entityConstructor);
                break;
            case 'patch':
     ...
     * @returns The entity itself, to facilitate method chaining
     */
    UpdateRequestBuilderV4.prototype.requiredFields = function () {
        var fields = [];
     ...
     * @returns The entity itself, to facilitate method chaining
     */
    UpdateRequestBuilderV4.prototype.ignoredFields = function () {
        var fields = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            fields[_i] = arguments[_i];
        }
    ...
    UpdateRequestBuilderV4.prototype.getUpdateBody = function () {
        var _this = this;
        var serializedBody = entity_serializer_1.serializeEntityV4(this._entity, this._entityConstructor);
        return rambda_1.pipe(function () { return _this.serializedDiff(); }, function (body) { return _this.removeNavPropsAndComplexTypes(body); }, function (body) { return _this.removeKeyFields(body); }, function (body) { return _this.addRequiredFields(serializedBody, body); }, function (body) { return _this.removeIgnoredFields(body); })();
    };
    ...
    UpdateRequestBuilderV4.prototype.removeNavPropsAndComplexTypes = function (body) {
    ...
    UpdateRequestBuilderV4.prototype.toSet = function () {
        var fields = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            fields[_i] = arguments[_i];
        }
