 ...
 */
export declare class GetByKeyRequestBuilderV4<EntityT extends EntityV4> extends MethodRequestBuilderBase<ODataGetByKeyRequestConfig<EntityT>> implements EntityIdentifiable<EntityT> {
     ...
     */
    constructor(_entityConstructor: Constructable<EntityT>, keys: MapType<FieldType>);
    /**
