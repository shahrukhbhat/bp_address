...
import { AllFields, BigNumberField, BooleanField, CustomField, DateField, Entity, EntityBuilderType, Field, Link, StringField } from '@sap-cloud-sdk/core';
/**
 * See https://api.sap.com/api/API_BUSINESS_PARTNER for more information.
 */
...
export declare namespace SupplierCompany {
     ...
     */
    const _allFields: Array<StringField<SupplierCompany> | BooleanField<SupplierCompany> | BigNumberField<SupplierCompany> | DateField<SupplierCompany> | Link<SupplierCompany, SupplierDunning> | Link<SupplierCompany, SupplierWithHoldingTax>>;
    /**
     * All fields selector.
     */
